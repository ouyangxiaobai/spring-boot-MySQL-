<template>
	<div class="diy_details_box diy_div_instruments_and_equipment">
		<div class="warp">
			<div class="container">
					...
					<div class="view praise_wrap">
						...
						{{ praiseLen }}
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/instrument_reservation/edit','add')" @click="to_form('/instrument_reservation/edit')" >预约 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/instruments_and_equipment/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/instruments_and_equipment/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
