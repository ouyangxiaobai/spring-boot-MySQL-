...
const routes = [
	...
	//仪器设备列表路由
	{
		path: '/instruments_and_equipment/list',
		name: '/instruments_and_equipment_list',
		component: () => import('../views/instruments_and_equipment/list.vue')
	},
	//仪器设备详情路由
	{
		path: '/instruments_and_equipment/details',
		name: '/instruments_and_equipment_details',
		component: () => import('../views/instruments_and_equipment/details.vue')
	},
	//仪器预约添加路由
	{
		path: '/instrument_reservation/edit',
		name: '/instrument_reservation_edit',
		component: () => import('../views/instrument_reservation/edit.vue')
	},
	//学习资料列表路由
	{
...
router.afterEach((to, from, next) => {
	let title = "高校大型仪器设备管理平台-home";
	document.title = title;
	document.logo = "高校大型仪器设备管理平台"
})
